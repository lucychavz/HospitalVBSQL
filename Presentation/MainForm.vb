...
#Region "-> Métodos"
    ...
    Private Sub Security()
        ...
        If userModel.ValidateActiveUser() = False Then 'Si el usuario no se ha autenticado, Cerrar la aplicacion.
            ...
            Application.[Exit]()
        End If
        'Estp es Opcional, muchas veces en las aplicaciones de escritorio no es necesario.
    End Sub
...
#Region "- Abrir formularios secundarios"
    ...
    Private Sub btnUsers_Click(sender As Object, e As EventArgs) Handles btnUsers.Click
        OpenChildForm(Of FormUsers)(sender)
    ...
    Private Sub btnPacients_Click(sender As Object, e As EventArgs) Handles btnPacients.Click
        OpenChildForm(Of FormPacients)(sender)
    End Sub
    ...
    Private Sub btnCalendar_Click(sender As Object, e As EventArgs) Handles btnCalendar.Click
        OpenChildForm(Of FormCalendar)(sender)
    End Sub

    Private Sub btnReports_Click(sender As Object, e As EventArgs) Handles btnReports.Click
        OpenChildForm(Of FormReports)(sender)
    End Sub
    ...
    Private Sub linkProfile_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles linkProfile.LinkClicked
        ...
        OpenChildForm(Of FormUserProfile)(Nothing)
